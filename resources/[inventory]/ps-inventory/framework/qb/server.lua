...
SetTimeout(500, function()
	...
	local resourcesToStop = { 'qb-shops', 'ps-inventory', 'qb-weapons' }
...
-- Event overrides
Core.Utilities.ExportHandler('ps-inventory', 'HasItem', Framework.Server.HasItem)
Core.Utilities.ExportHandler('ps-inventory', 'RemoveItem', Core.Classes.Inventory.RemoveItem)
Core.Utilities.ExportHandler('ps-inventory', 'AddItem', Core.Classes.Inventory.AddItem)
Core.Utilities.ExportHandler('ps-inventory', 'OpenInventoryById', Core.Classes.Inventory.OpenInventoryById)
Core.Utilities.ExportHandler('ps-inventory', 'OpenInventory', function (src, stashName)
...
-------------------------------------------------
RegisterNetEvent("ps-inventory:server:OpenInventory", function(type, id, name, table)
    local src = source
    if type == 'stash' then
        Core.Classes.Inventory.OpenStash(source, id)
    elseif type == 'shop'then
